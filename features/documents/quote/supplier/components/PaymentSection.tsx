...
export function PaymentSection({ totals }: Props) {
  ...
  return (
    <SectionCard>
      ...
      />
      <div className="overflow-hidden rounded-xl bg-[#F8F9FA] mb-4">
        <div className="grid sm:grid-cols-3">
          <div className={columnBase}>
            <p className="text-xs font-medium text-slate-400">선금 비율</p>
            <p className="text-2xl font-bold tracking-tight text-[#3182F6]">30%</p>
          ...
          >
            ...
            <p className="text-2xl font-bold tracking-tight text-[#8B5CF6]">70%</p>
