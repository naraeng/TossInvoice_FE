    ...
    <aside className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-[0_8px_30px_-24px_rgba(15,23,42,0.25)]">
      ...
      <div className="p-6">
        ...
        <div className="mt-3 space-y-2">
          <Button
            className="h-auto w-full flex-col gap-0.5 rounded-xl bg-[#3182F6] py-3.5 text-sm font-bold shadow-[0_4px_14px_-4px_rgba(49,130,246,0.55)] hover:bg-[#1b64da]"
            onClick={onStartPo}
            disabled={busy}
          >
            해당 내용으로 발주서 작성하기
          ...
          <Button
            variant="outline"
            className="h-11 w-full rounded-xl border-rose-200 bg-white text-sm font-semibold text-rose-600 hover:bg-rose-50"
            onClick={onReject}
            disabled={busy}
          >
            거래 취소·수정 요청
